      ...
      <div className={styles.dashboard}>
        ...
        <div className={styles.choose}>
          ...
          <div className={styles.switcher}>
            ...
            <input id="input" type="checkbox" className={styles.input} 

            onClick ={ e=> setLight(e.target.checked)}
            
            />
            <label for="input" className={styles.label}></label>
        ...
        <div className={styles.container}>
          <SmallBox>
            ...
            <div className={styles.display}>
              ...
              <p className={styles.green}> <span> <svg xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#1EB589" fill-rule="evenodd" d="M0 4l4-4 4 4z"/></svg> </span>3% </p>
          ...
          <SmallBox>
            ...
            <div className={styles.display}>
              ...
              <p className={styles.red}> <span> <svg xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#DC414C" fill-rule="evenodd" d="M0 0l4 4 4-4z"/></svg> </span>2% </p>
          ...
          <SmallBox>
            ...
            <div className={styles.display}>
              ...
              <p className={styles.green}> <span> <svg xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#1EB589" fill-rule="evenodd" d="M0 4l4-4 4 4z"/></svg> </span>2257% </p>
          ...
          <SmallBox>
            ...
            <div className={styles.display}>
              ...
              <p className={styles.green}> <span> <svg xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#1EB589" fill-rule="evenodd" d="M0 4l4-4 4 4z"/></svg> </span>1375% </p>
          ...
          <SmallBox>
            ...
            <div className={styles.display}>
              ...
              <p className={styles.green}> <span> <svg xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#1EB589" fill-rule="evenodd" d="M0 4l4-4 4 4z"/></svg> </span>303% </p>
          ...
          <SmallBox>
            ...
            <div className={styles.display}>
              ...
              <p className={styles.green}> <span> <svg xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#1EB589" fill-rule="evenodd" d="M0 4l4-4 4 4z"/></svg> </span>553% </p>
          ...
          <SmallBox>
            ...
            <div className={styles.display}>
              ...
              <p className={styles.red}> <span> <svg xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#DC414C" fill-rule="evenodd" d="M0 0l4 4 4-4z"/></svg> </span>19% </p>
          ...
          <SmallBox>
            ...
            <div className={styles.display}>
              ...
              <p className={styles.red}> <span> <svg xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#DC414C" fill-rule="evenodd" d="M0 0l4 4 4-4z"/></svg> </span>12% </p>
